...
execute as @s at @s if entity @e[type=minecraft:armor_stand,name="map-center"] if score lobby game-state matches 1 as @a at @s run attribute @s minecraft:generic.attack_speed base set 100
