...
execute if score $countdown uhc.lobby.start_countdown matches 1 run title @a subtitle {"text":"Teleporting...","color":"yellow"}
execute if score $countdown uhc.lobby.start_countdown matches 1 run title @a title ""
execute if score $countdown uhc.lobby.start_countdown matches 1 run execute as @a at @s run playsound block.note_block.hat master @s ~ ~ ~ 1 1 1
