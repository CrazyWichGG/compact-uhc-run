...
# countdown fail
execute if score $countdown uhc.lobby.start_countdown matches 0..399 unless score $total_ready uhc.lobby.ready_status = $total_player uhc.lobby.ready_status run function uhc:system/lobby/start/countdown_fail {message:"Some players are not ready!"}
execute if score $countdown uhc.lobby.start_countdown matches 0..399 unless score $total_player uhc.lobby.ready_status matches 2.. run function uhc:system/lobby/start/countdown_fail {message:"Not enough players!"}
...
execute unless score $total_player uhc.lobby.ready_status matches 2.. run return run scoreboard players set $countdown uhc.lobby.start_countdown 400
