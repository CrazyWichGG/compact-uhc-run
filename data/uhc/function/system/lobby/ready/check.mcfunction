...
execute unless score $total_player uhc.lobby.ready_status matches 2.. run bossbar set uhc:lobby.ready_status name {"text":"Must have at least 2 players to start the game","color":"red"}
execute unless score $total_player uhc.lobby.ready_status matches 2.. run bossbar set uhc:lobby.ready_status color red

execute if score $total_player uhc.lobby.ready_status matches 2.. unless score $total_ready uhc.lobby.ready_status = $total_player uhc.lobby.ready_status run bossbar set uhc:lobby.ready_status name [{"text":"("},{"score":{"objective":"uhc.lobby.ready_status","name":"$total_ready"}},{"text":"/"},{score:{"objective":"uhc.lobby.ready_status","name":"$total_player"}},{"text":") Players Ready"}]
execute if score $total_player uhc.lobby.ready_status matches 2.. unless score $total_ready uhc.lobby.ready_status = $total_player uhc.lobby.ready_status run bossbar set uhc:lobby.ready_status color green

execute if score $total_player uhc.lobby.ready_status matches 2.. if score $total_ready uhc.lobby.ready_status = $total_player uhc.lobby.ready_status run bossbar set uhc:lobby.ready_status name [{"text":"(","color":"green"},{"score":{"objective":"uhc.lobby.ready_status","name":"$total_ready"},"color":"green"},{"text":"/","color":"green"},{score:{"objective":"uhc.lobby.ready_status","name":"$total_player"},"color":"green"},{"text":") Players Ready","color":"green"}]
execute if score $total_player uhc.lobby.ready_status matches 2.. if score $total_ready uhc.lobby.ready_status = $total_player uhc.lobby.ready_status run bossbar set uhc:lobby.ready_status color green