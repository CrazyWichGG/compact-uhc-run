#mob kill
execute as @a at @s if score @s entity-kills matches 1.. run give @s minecraft:emerald 1
execute as @a at @s if score @s entity-kills matches 1.. run title @s actionbar [{"text":"+1 Emerald","color":"green"},{"text":" (Killed Mob)","color":"gray"}]
execute as @a at @s if score @s entity-kills matches 1.. run scoreboard players remove @s entity-kills 1

#player kill
execute as @a at @s if score @s player-kills matches 1.. run give @s minecraft:emerald 19
...
execute as @a at @s if score @s player-kills matches 1.. run scoreboard players remove @s player-kills 1
...
execute as @a at @s if score @s mined-ore-lapis matches 1.. run title @s actionbar [{"text":"+2 Emeralds","color":"green"},{"text":" (Mined Lapis Ore)","color":"gray"}]
...
execute as @a at @s if score @s mined-ore-deepslate-lapis matches 1.. run title @s actionbar [{"text":"+2 Emeralds","color":"green"},{"text":" (Mined Deepslate Lapis Ore)","color":"gray"}]
