...
execute as @a[team=!ingame,team=!spectator] at @s if score lobby game-state matches 0 run bossbar set minecraft:gen-chunk players @s
execute as @a[team=!ingame,team=!spectator] at @s if score lobby game-state matches 0 run bossbar set minecraft:ingame players @s
execute as @a[team=!ingame,team=!spectator] at @s if score lobby game-state matches 0 run bossbar set minecraft:invincibility players @s
