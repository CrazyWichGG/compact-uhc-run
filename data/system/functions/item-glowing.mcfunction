...
# -aqua
# execute as @e[type=item,nbt={Item:{id:"minecraft:diamond"}}] run data modify entity @s Glowing set value true
# execute as @e[type=item,nbt={Item:{id:"minecraft:diamond"}}] run team join glowing-color-aqua @s
# execute as @e[type=item,nbt={Item:{id:"minecraft:diamond_block"}}] run data modify entity @s Glowing set value true
# execute as @e[type=item,nbt={Item:{id:"minecraft:diamond_block"}}] run team join glowing-color-aqua @s
...
# -red
execute as @e[type=item,nbt={Item:{id:"minecraft:nether_star",tag:{special-item:shop-menu}}}] run data modify entity @s Glowing set value true
execute as @e[type=item,nbt={Item:{id:"minecraft:nether_star",tag:{special-item:shop-menu}}}] run team join glowing-color-red @s
