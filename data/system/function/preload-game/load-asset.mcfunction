...
execute if score load-asset game-state matches 1 if score loaded-asset preload-game matches 13 run title @a subtitle [{"text":"Loading Supply Drop phase 6...","color":"yellow"}]
execute if score load-asset game-state matches 1 if score loaded-asset preload-game matches 14 run title @a subtitle [{"text":"Loading Supply Drop phase 7...","color":"yellow"}]
...
execute if score load-asset game-state matches 1 if score loaded-asset preload-game = required-asset preload-game as @e[type=armor_stand,tag=supply-drop,team=supply-state-loaded] at @s run team join supply-state-prepare @s
