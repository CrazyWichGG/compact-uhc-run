...
execute as @e[tag=!raycasting,dx=0] positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] positioned ~0.99 ~0.99 ~0.99 run function system:custom-active/gun/raycast/sniper/collide
...
execute if score @s custom-gun-bullet-distance matches ..5000 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #system:raycast_sniper_passable run function system:custom-active/gun/raycast/sniper/raycasting
