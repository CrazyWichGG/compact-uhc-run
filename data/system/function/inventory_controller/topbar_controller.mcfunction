...
execute if score @s[tag=!admin] inventory_controller.active_page matches 3000..3999 run item modify entity @s inventory.4 system:inventory_controller/custom_no_permission
