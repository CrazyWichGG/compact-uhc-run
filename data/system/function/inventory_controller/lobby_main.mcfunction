...
execute if score lobby game-state matches 1 as @a[gamemode=!creative,gamemode=!spectator] at @s if items entity @s player.cursor *[custom_data~{inventory_controller:1b,inventory_controller_item:lobby_menu.cosmetics.gliding_effects.soul}] run scoreboard players set @s cosmetics.gliding_effects 4
execute if score lobby game-state matches 1 as @a[gamemode=!creative,gamemode=!spectator] at @s if items entity @s player.cursor *[custom_data~{inventory_controller:1b,inventory_controller_item:lobby_menu.cosmetics.gliding_effects.flame}] run scoreboard players set @s cosmetics.gliding_effects 5
