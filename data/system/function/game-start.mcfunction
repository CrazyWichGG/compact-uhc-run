...
#customs
# -old combat
execute if score old-combat custom matches 1 as @a[team=ingame] at @s run loot replace entity @s weapon.offhand loot system:inventory_handler/custom/old_combat/old_combat_shield
