execute as @e[type=armor_stand,name="border-center",limit=1] at @s if entity @e[type=armor_stand,name="border-target",limit=1,distance=..0.1] at @e[type=armor_stand,name='map-center',limit=1] run spreadplayers ~ ~ 0 100 false @e[type=armor_stand,name="border-target",limit=1]
