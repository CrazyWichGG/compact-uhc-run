...
execute as @a[team=!spectator] at @s if score @s hold-shop matches 1.. unless entity @e[type=minecraft:wandering_trader,limit=1,distance=0] run tp @e[type=minecraft:wandering_trader,limit=1,distance=..2] ~ ~ ~
