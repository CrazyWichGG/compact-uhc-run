...
execute as @a[team=!spectator] if entity @s[nbt={SelectedItem:{id:"minecraft:nether_star",components:{"minecraft:custom_data":{special-item:shop-menu}}}}] run scoreboard players add @s hold-shop 1
execute as @a[team=!spectator] if entity @s[nbt=!{SelectedItem:{id:"minecraft:nether_star",components:{"minecraft:custom_data":{special-item:shop-menu}}}}] run scoreboard players set @s hold-shop 0

execute as @a[team=!spectator] at @s if score @s hold-shop matches 1 run summon minecraft:wandering_trader ~ ~-2 ~ {Invulnerable:1b,CanPickUpLoot:0b,NoAI:1b,Silent:1b,DespawnDelay:-1,Offers:{Recipes:[{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:4},sell:{id:"golden_apple",count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:2},sell:{id:"iron_ingot",count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:8},buyB:{id:"copper_ingot",count:4},sell:{id:"diamond",count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:1},buyB:{id:"lapis_lazuli",count:2},sell:{id:"experience_bottle",count:4}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:16},buyB:{id:"gold_ingot",count:4},sell:{id:"brewing_stand",count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:8},buyB:{id:"redstone",count:8},sell:{id:nether_wart,count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:16},buyB:{id:"redstone",count:48},sell:{id:"blaze_rod",count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:16},buyB:{id:"gold_ingot",count:24},sell:{id:"glowstone_dust",count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:2},sell:{id:"wind_charge",count:8}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:16},sell:{id:"slime_block",count:1,components:{custom_name:'[{"text":"Jump Pad","italic":false,"color":"yellow"},{"text":" (Place)","color":"gray"}]',lore:['[{"text":"Place on the ground and step on","italic":false,"color":"white"}]','[{"text":"to fly up and glide down.","italic":false,"color":"white"}]']}}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:1},sell:{id:"arrow",count:2}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:1},buyB:{id:"copper_ingot",count:1},sell:{id:"spectral_arrow",count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:16},buyB:{id:"copper_ingot",count:16},sell:{id:"ender_pearl",count:1}},{maxUses:999999,rewardExp:0b,buy:{id:"emerald",count:64},buyB:{id:"gold_ingot",count:32},sell:{id:"totem_of_undying",count:1}}]},active_effects:[{id:"invisibility",duration:999999,amplifier:0,show_particles:0b},{id:"resistance",duration:999999,amplifier:0,show_particles:0b}]}
...
execute as @a[team=!spectator] at @s if score @s hold-shop matches 1.. run tp @e[type=minecraft:wandering_trader,limit=1,distance=..2] ~ ~ ~
