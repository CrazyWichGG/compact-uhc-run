...
#title
execute if score gen-chunk game-state matches 1 run title @a actionbar [{"text":"Completed Players ","color":"yellow"},{"text":"(","color":"yellow"},{"score":{"name":"player-generated","objective":"preload-game"},"color":"yellow"},{"text":"/","color":"yellow"},{"score":{"name":"player-total","objective":"preload-game"},"color":"yellow"},{"text":")","color":"yellow"}]
...
execute if score gen-chunk game-state matches 1 as @a[team=ingame] at @s if score @s is-chunk-generated matches 25 run title @s title [{"text":"Completed!","color":"green"}]
...
execute if score gen-chunk game-state matches 1 if score player-generated preload-game matches 1.. if score player-generated preload-game = player-total preload-game as @a at @s run playsound block.note_block.hat master @s ~ ~ ~ 1 1 1
execute if score gen-chunk game-state matches 1 if score player-generated preload-game matches 1.. if score player-generated preload-game = player-total preload-game run title @a actionbar ""
...
execute if score gen-chunk game-state matches 1 if score player-generated preload-game matches 1.. if score player-generated preload-game = player-total preload-game run scoreboard players set ingame game-state 0
execute if score gen-chunk game-state matches 1 if score player-generated preload-game matches 1.. if score player-generated preload-game = player-total preload-game run scoreboard players set load-asset game-state 1
