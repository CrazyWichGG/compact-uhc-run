...
execute as @s[tag=setup-uninstall-request] at @s run scoreboard objectives remove cosmetics.kill_effects.playing
# execute as @s[tag=setup-uninstall-request] at @s run scoreboard objectives remove cosmetics.victory_dances
execute as @s[tag=setup-uninstall-request] at @s run scoreboard objectives remove cosmetics.victory_dances.playing
...
#max health reset
execute as @s[tag=setup-uninstall-request] at @s run execute as @a at @s run attribute @s max_health modifier remove max_health
