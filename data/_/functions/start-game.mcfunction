...
execute as @s at @s if entity @e[type=minecraft:armor_stand,name="map-center"] if score player-left player < can-start player run tellraw @s {"text":"Must be at least 2 players to start game.","color":"red"}
