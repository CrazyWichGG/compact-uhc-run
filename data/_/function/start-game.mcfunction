...
execute as @s at @s if entity @e[type=minecraft:armor_stand,name="map-center"] if score lobby game-state matches 1 if score player-left player >= can-start player run function system:game-before-start
